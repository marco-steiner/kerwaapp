<template>
  <layout>
    ...
    <transition :name="transitionDirection" :duration="1300">
      <div class="page" :class="transitionDirection" :is="page" @change-page="onChangePage"></div>
    </transition>
    <div class="footerNav">
        <g-link class="nav__link" aria-label="home" to="/"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="24.222" viewBox="0 0 22 24.222"><g transform="translate(-3.5 -2)"><path d="M4.5,10.778,14.5,3l10,7.778V23a2.222,2.222,0,0,1-2.222,2.222H6.722A2.222,2.222,0,0,1,4.5,23Z" transform="translate(0 0)" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/><path d="M13.5,29.111V18h9V29.111" transform="translate(-3.5 -3.889)" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/></g></svg></g-link>
        <g-link class="nav__link" aria-label="kerwalieder" to="/kerwalieder/"><svg xmlns="http://www.w3.org/2000/svg" width="21.523" height="21.523" viewBox="0 0 21.523 21.523"><g transform="translate(-3.5 -3.5)"><path d="M13.5,20.77V6.669L26.516,4.5V18.6" transform="translate(-2.492)" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/><path d="M11.008,25.754A3.254,3.254,0,1,1,7.754,22.5,3.254,3.254,0,0,1,11.008,25.754Z" transform="translate(0 -4.984)" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/><path d="M29.008,22.754A3.254,3.254,0,1,1,25.754,19.5,3.254,3.254,0,0,1,29.008,22.754Z" transform="translate(-4.984 -4.154)" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/></g></svg></g-link>
        <g-link class="nav__link" aria-label="kerwakalender" to="/kerwakalender/"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="24.222" viewBox="0 0 22 24.222"><g transform="translate(-3.5 -2)"><path d="M6.722,6H22.278A2.18,2.18,0,0,1,24.5,8.136V23.086a2.18,2.18,0,0,1-2.222,2.136H6.722A2.18,2.18,0,0,1,4.5,23.086V8.136A2.18,2.18,0,0,1,6.722,6Z" transform="translate(0)" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/><path d="M24,3V9" transform="translate(-5.056)" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/><path d="M12,3V9" transform="translate(-1.944)" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/><path d="M4.5,15h20" transform="translate(0 -3.111)" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/></g></svg></g-link>
        <g-link class="nav__link" aria-label="zeitplan" to="/zeitplan/"><svg xmlns="http://www.w3.org/2000/svg" width="22.92" height="16.667" viewBox="0 0 22.92 16.667"><g transform="translate(-3.5 -8)"><path d="M12,9H28.7" transform="translate(-3.279)" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/><path d="M12,18H28.7" transform="translate(-3.279 -1.667)" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/><path d="M12,27H28.7" transform="translate(-3.279 -3.333)" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/><path d="M4.5,9h0" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/><path d="M4.5,18h0" transform="translate(0 -1.667)" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/><path d="M4.5,27h0" transform="translate(0 -3.333)" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/></g></svg></g-link>
        <g-link class="nav__link" aria-label="infos" to="/infos/"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"><g transform="translate(-2 -2)"><path d="M23,13A10,10,0,1,1,13,3,10,10,0,0,1,23,13Z" transform="translate(0 0)" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/><path d="M18,24V18" transform="translate(-5 -6.25)" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/><path d="M18,12h0" transform="translate(-5 -3)" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/></g></svg></g-link>
    </div>
  </layout>
</template>
...
.page {
  ...
  padding: 50px 0;
  text-align: center;
  box-shadow: 2px 0px 10px -3px rgba(0,0,0,0.46);
}
</style>